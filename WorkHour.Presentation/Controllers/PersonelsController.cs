...
namespace WorkHour.Presentation.Controllers
{
    public class PersonelsController : Controller
    {
        ...
        public PersonelsController(WorkHourContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Mission,Phone,Adress,UserName,Password,Deleted")] Personel personel)
        {
