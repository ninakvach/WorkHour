...
namespace WorkHour.Presentation.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(WorkHourContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerName,Phone,Adress,Email,Deleted")] Customer customer)
        {
